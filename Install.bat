...
echo   Tested on game patch 2026-09-18 / buildid 25375493
...
echo Tested on game patch 2026-09-18 / buildid 25375493 - newer game builds may break.
echo After Steam "Verify game files" run Install.bat again.
echo This mod is UNSUPPORTED.
echo.
echo Opening mderick.dev ...
start "" "https://mderick.dev/?utm_source=funnelrunners_ru&utm_medium=installer&utm_campaign=install_bat&utm_content=v0_1_19#services"
pause
exit /b 0
